...
The goal of regexcitesu1 is to make regular expressions more exciting!
It provides convenience functions to make some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the development version of regexcitesu1 from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("jennybc/regexcitesu1")
```
...
That’s exactly what `regexcitesu1::str_split_one()` does.

``` r
library(regexcitesu1)
